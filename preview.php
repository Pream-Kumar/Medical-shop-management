...
<body>
  ...
  <div class="container">
  	...
  	<a href="home.php?invoice_number=<?php echo $_GET['invoice_number']?>"><button class="btn btn-default" style="border-radius: 15px;"><i class="icon-arrow-left"></i> Back to Sales</button></a>

    <div id="content">

	<center><div style="font:bold 25px 'Arial';">Maharaja Medicals</div><br>
