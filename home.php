...
<body>
 ...
 <div class="container">
   ...
   <!-- </div> -->
     ...
     <Button type="submit"  name="submit" class="btn btn-success" id="btn_submit" style="width: 130px; height:40px; margin-top:-8px; border-radius: 15px;"><i class="icon icon-plus-sign"></i> Add to Cart</button>
      </form> 
      </div>
    </center>
     </div>
